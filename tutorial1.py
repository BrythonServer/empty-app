...
ImageAsset(self, http://a1.mzstatic.com/us/r30/Purple5/v4/5a/2e/e9/5a2ee9b3-8f0e-4f8b-4043-dd3e3ea29766/icon256.png, frame=None, qty=1, direction='horizontal', margin=0)
myapp = App()
myapp.run()
